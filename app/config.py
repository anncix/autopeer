...
class Settings(BaseSettings):
    ...
    @property
    def local_asn_number(self) -> str:
        """Return the local ASN as a plain number, stripping any 'AS' prefix if present."""
        value = self.local_asn.strip().upper()
